    ...
    children: [
      {
        ...
        children: [
          ...
          { value: '710104', label: '万华区' },
          { value: '710105', label: '信义区' },
          { value: '710106', label: '松山区' },
          { value: '710107', label: '大安区' },
          { value: '710108', label: '南港区' },
      ...
      },
      {
        ...
        children: [
          ...
          { value: '710202', label: '土城区' },
          { value: '710203', label: '新庄区' },
          { value: '710204', label: '新店区' },
          { value: '710205', label: '深坑区' },
          { value: '710206', label: '石碇区' },
          { value: '710207', label: '坪林区' },
          { value: '710208', label: '乌来区' },
          { value: '710209', label: '五股区' },
          { value: '710210', label: '八里区' },
          { value: '710211', label: '林口区' },
          { value: '710212', label: '淡水区' },
          { value: '710213', label: '中和区' },
          { value: '710214', label: '永和区' },
          { value: '710215', label: '三重区' },
          { value: '710216', label: '芦洲区' },
          { value: '710217', label: '泰山区' },
          { value: '710218', label: '树林区' },
          { value: '710219', label: '莺歌区' },
          { value: '710220', label: '三峡区' },
          { value: '710221', label: '汐止区' },
          { value: '710222', label: '金山区' },
          { value: '710223', label: '万里区' },
          { value: '710224', label: '三芝区' },
          { value: '710225', label: '石门区' },
          { value: '710226', label: '瑞芳区' },
          { value: '710227', label: '贡寮区' },
          { value: '710228', label: '双溪区' },
      ...
      },
      {
        ...
        children: [
          ...
          { value: '710307', label: '大溪区' },
          { value: '710308', label: '龙潭区' },
          { value: '710309', label: '龟山区' },
      ...
      },
      {
        ...
        children: [
          ...
          { value: '710403', label: '西区' },
          { value: '710404', label: '南区' },
          { value: '710405', label: '北区' },
          { value: '710406', label: '西屯区' },
          { value: '710407', label: '南屯区' },
          { value: '710408', label: '北屯区' },
          { value: '710409', label: '丰原区' },
          { value: '710410', label: '大里区' },
          { value: '710411', label: '太平区' },
          { value: '710412', label: '东势区' },
          { value: '710413', label: '大甲区' },
          { value: '710414', label: '清水区' },
          { value: '710415', label: '沙鹿区' },
          { value: '710416', label: '梧栖区' },
          { value: '710417', label: '后里区' },
          { value: '710418', label: '神冈区' },
          { value: '710419', label: '潭子区' },
          { value: '710420', label: '大雅区' },
          { value: '710421', label: '新小区' },
          { value: '710422', label: '石冈区' },
          { value: '710423', label: '外埔区' },
          { value: '710424', label: '大安区' },
          { value: '710425', label: '乌日区' },
          { value: '710426', label: '大肚区' },
          { value: '710427', label: '龙井区' },
          { value: '710428', label: '雾峰区' },
      ...
      },
      {
        ...
        children: [
          ...
          { value: '710507', label: '永康区' },
          { value: '710508', label: '归仁区' },
          { value: '710509', label: '新化区' },
          { value: '710510', label: '左镇区' },
          { value: '710511', label: '玉井区' },
          { value: '710512', label: '楠西区' },
          { value: '710513', label: '南化区' },
          { value: '710514', label: '仁德区' },
          { value: '710515', label: '关庙区' },
          { value: '710516', label: '龙崎区' },
          { value: '710517', label: '官田区' },
          { value: '710518', label: '麻豆区' },
          { value: '710519', label: '佳里区' },
          { value: '710520', label: '西港区' },
          { value: '710521', label: '七股区' },
          { value: '710522', label: '将军区' },
          { value: '710523', label: '学甲区' },
          { value: '710524', label: '北门区' },
          { value: '710525', label: '新营区' },
          { value: '710526', label: '后壁区' },
          { value: '710527', label: '白河区' },
          { value: '710528', label: '东山区' },
          { value: '710529', label: '六甲区' },
          { value: '710530', label: '下营区' },
          { value: '710531', label: '柳营区' },
          { value: '710532', label: '盐水区' },
          { value: '710533', label: '善化区' },
          { value: '710534', label: '大内区' },
          { value: '710535', label: '山上区' },
          { value: '710536', label: '新市区' },
          { value: '710537', label: '安定区' },
        ],
      },
      {
        value: '710600',
        label: '高雄市',
        children: [
          { value: '710601', label: '楠梓区' },
          { value: '710602', label: '左营区' },
          { value: '710603', label: '鼓山区' },
          { value: '710604', label: '三民区' },
          { value: '710605', label: '盐埕区' },
          { value: '710606', label: '前金区' },
          { value: '710607', label: '新兴区' },
          { value: '710608', label: '苓雅区' },
          { value: '710609', label: '前镇区' },
          { value: '710610', label: '旗津区' },
          { value: '710611', label: '小港区' },
          { value: '710612', label: '凤山区' },
          { value: '710613', label: '大寮区' },
          { value: '710614', label: '鸟松区' },
          { value: '710615', label: '林园区' },
          { value: '710616', label: '仁武区' },
          { value: '710617', label: '大树区' },
          { value: '710618', label: '大社区' },
          { value: '710619', label: '冈山区' },
          { value: '710620', label: '路竹区' },
          { value: '710621', label: '桥头区' },
          { value: '710622', label: '梓官区' },
          { value: '710623', label: '弥陀区' },
          { value: '710624', label: '永安区' },
          { value: '710625', label: '燕巢区' },
          { value: '710626', label: '阿莲区' },
          { value: '710627', label: '茄萣区' },
          { value: '710628', label: '湖内区' },
          { value: '710629', label: '旗山区' },
          { value: '710630', label: '美浓区' },
          { value: '710631', label: '内门区' },
          { value: '710632', label: '杉林区' },
          { value: '710633', label: '甲仙区' },
          { value: '710634', label: '六龟区' },
          { value: '710635', label: '茂林区' },
      ...
      },
      {
        ...
        label: '基隆市',
        children: [
          { value: '710701', label: '中正区' },
          { value: '710702', label: '七堵区' },
          { value: '710703', label: '暖暖区' },
          { value: '710704', label: '仁爱区' },
          { value: '710705', label: '中山区' },
          { value: '710706', label: '安乐区' },
          { value: '710707', label: '信义区' },
        ],
      },
      {
        value: '710800',
      ...
      { value: '719001', label: '宜兰县', children: [{ value: '719001', label: '宜兰县' }] },
      { value: '719002', label: '新竹县', children: [{ value: '719002', label: '新竹县' }] },
      { value: '719003', label: '苗栗县', children: [{ value: '719003', label: '苗栗县' }] },
      { value: '719004', label: '彰化县', children: [{ value: '719004', label: '彰化县' }] },
      { value: '719005', label: '南投县', children: [{ value: '719005', label: '南投县' }] },
      { value: '719006', label: '嘉义县', children: [{ value: '719006', label: '嘉义县' }] },
      { value: '719007', label: '云林县', children: [{ value: '719007', label: '云林县' }] },
      { value: '719008', label: '屏东县', children: [{ value: '719008', label: '屏东县' }] },
      { value: '719009', label: '台东县', children: [{ value: '719009', label: '台东县' }] },
      { value: '719010', label: '花莲县', children: [{ value: '719010', label: '花莲县' }] },
      { value: '719011', label: '澎湖县', children: [{ value: '719011', label: '澎湖县' }] },
      { value: '719012', label: '金门县', children: [{ value: '719012', label: '金门县' }] },
      { value: '719013', label: '连江县', children: [{ value: '719013', label: '连江县' }] },
    ],
  },
  {
    value: '810000',
    label: '香港特别行政区',
    children: [
      { value: '810101', label: '中西区', children: [{ value: '810101', label: '中西区' }] },
      { value: '810102', label: '湾仔区', children: [{ value: '810102', label: '湾仔区' }] },
      { value: '810103', label: '东区', children: [{ value: '810103', label: '东区' }] },
      { value: '810104', label: '南区', children: [{ value: '810104', label: '南区' }] },
      { value: '810105', label: '油尖旺区', children: [{ value: '810105', label: '油尖旺区' }] },
      { value: '810106', label: '深水埗区', children: [{ value: '810106', label: '深水埗区' }] },
      { value: '810107', label: '九龙城区', children: [{ value: '810107', label: '九龙城区' }] },
      { value: '810108', label: '黄大仙区', children: [{ value: '810108', label: '黄大仙区' }] },
      { value: '810109', label: '观塘区', children: [{ value: '810109', label: '观塘区' }] },
      { value: '810110', label: '北区', children: [{ value: '810110', label: '北区' }] },
      { value: '810111', label: '大埔区', children: [{ value: '810111', label: '大埔区' }] },
      { value: '810112', label: '沙田区', children: [{ value: '810112', label: '沙田区' }] },
      { value: '810113', label: '西贡区', children: [{ value: '810113', label: '西贡区' }] },
      { value: '810114', label: '荃湾区', children: [{ value: '810114', label: '荃湾区' }] },
      { value: '810115', label: '屯门区', children: [{ value: '810115', label: '屯门区' }] },
      { value: '810116', label: '元朗区', children: [{ value: '810116', label: '元朗区' }] },
      { value: '810117', label: '葵青区', children: [{ value: '810117', label: '葵青区' }] },
      { value: '810118', label: '离岛区', children: [{ value: '810118', label: '离岛区' }] },
    ],
  },
  {
    value: '820000',
    ...
    children: [
      {
        value: '820101',
        label: '花地玛堂区',
        children: [{ value: '820101', label: '花地玛堂区' }],
      },
      {
        value: '820102',
        label: '圣安多尼堂区',
        children: [{ value: '820102', label: '圣安多尼堂区' }],
      },
      { value: '820103', label: '大堂区', children: [{ value: '820103', label: '大堂区' }] },
      { value: '820104', label: '望德堂区', children: [{ value: '820104', label: '望德堂区' }] },
      { value: '820105', label: '风顺堂区', children: [{ value: '820105', label: '风顺堂区' }] },
      { value: '820106', label: '嘉模堂区', children: [{ value: '820106', label: '嘉模堂区' }] },
      {
        value: '820107',
        label: '圣方济各堂区',
        children: [{ value: '820107', label: '圣方济各堂区' }],
      },
      { value: '820108', label: '路氹城', children: [{ value: '820108', label: '路氹城' }] },
      { value: '820109', label: '澳门新城', children: [{ value: '820109', label: '澳门新城' }] },
    ],
  },
]
