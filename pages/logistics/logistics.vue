<template>
  <view>
    ...
    <view class="bgc_fff flex logistics_code_box b_b_2">
      <image
        class="logistics_icon m_r_24"
        src="http://www.liwanying.top/applate-icon/kuaidicheche.png"
        mode=""
      ></image>
    ...
    <view class="logistics_steps_box bgc_fff">
      <lyz-steps backgroundColor="#F0F3F5" :infoList="infoList">
        <template #icon="iconProps">
          <view
            class="logistics_steps_icon flex-aic flexr-jsc"
            :class="iconProps.index == 0 ? '' : 'logistics_steps_icon_out'"
          >
        ...
        <template #content="contentProps">
          <view class="p_b_24">
            <view
              class="m_b_8 flex flex-aife"
              :class="contentProps.index == 0 ? 'color_ff7000' : 'color_999'"
            >
            ...
            <view
              class="font_28"
              style="width: 614rpx"
              :class="contentProps.index == 0 ? 'color_333' : 'color_999'"
            >
  ...
  const infoList = ref([
    {
      ...
      context:
        '客户签收人: 他人代收 已签收 感谢使用圆通速递，期待再次为您服务 如有疑问请联系：13958492389，投诉电话：18248586322 疫情期间圆通每天对网点多次消毒，快递小哥新冠疫苗已接种，每天测量体温，佩戴口罩',
    ...
    },
    {
      ...
      context:
        '【浙江省金华市金东区傅村镇杨家分部公司】 派件中 派件人: 曾中奇 电话 13958492389 如有疑问，请联系：18248586322 新冠疫苗已接种。95161和185211号段的上海号码为圆通业务员专属号码',
    ...
    },
    {
      ...
      context:
        '【广东省广州市越秀区万福路公司】 已揽收 取件人: 吴行杨 (13268385578) 新冠疫苗已接种',
