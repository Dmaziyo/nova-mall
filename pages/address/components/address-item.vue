<template>
  <view class="m_t_24 bgc_fff address_item_box">
    <view class="b_b_2 flex flex-aic p_b_24">
      <image
        class="address_item_location m_r_16"
      ...
      <view class="flex-fitem">
        ...
        <view class="color_999 font_24 text_nowrap" style="max-width: 580rpx"
          >江苏省 南京市 雨花台区 云密城云密城云密城云密城云密城云密城云密城</view
        >
      </view>
    </view>
    <view class="p_t_24 flex-aic flexr-jsb">
      <view
        @tap="addressActive = !addressActive"
        class="address_item_check m_r_16"
        :class="addressActive ? 'address_item_check_active' : ''"
      ></view>
